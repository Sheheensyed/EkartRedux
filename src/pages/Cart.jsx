   ...
   <div className="md:grid grid-cols-[2fr_1fr] m-10">
      ...
      <div className='pt-5 px-10'>
        <div className='shadow-lg p-5'>
          ...
          <p className='mt-4 text-xl'>Grand Total : $ 47.97</p>
          <button className='w-full bg-green-600 text-white p-3 mt-5 hover:border hover:bg-white hover:border-green-600 hover:text-green-500' onClick={handleCheckOut}>Check Out</button>
        </div>
